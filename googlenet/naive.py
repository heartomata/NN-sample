...
class Inception(nn.Module):
    def __init__(self, in_channel, n1_1, n3x3red, n3x3, n5x5red, n5x5, pool_plane):
        ...
        self.branch3x3 = nn.Sequential(
            ...
            BasicConv2d(in_channel, n3x3, kernel_size=3, padding=1, stride=1)
        )

        # third line
        self.branch5x5 = nn.Sequential(
            #BasicConv2d(in_channel, n5x5red, kernel_size=1),
            BasicConv2d(in_channel, n5x5, kernel_size=5, padding=2, stride=1)
        )
...
class GoogleNet(nn.Module):
    def __init__(self, num_classes=NUM_CLASSES):
        ...
        self.a3 = Inception(192, 64, 96, 128, 16, 32, 32) #192
        self.b3 = Inception(416, 128, 128, 192, 32, 96, 64) #416 - 64

        self.max_pool3 = nn.MaxPool2d(3, stride=2, padding=1)

        self.a4 = Inception(832, 192, 96, 208, 16, 48, 64)
        self.b4 = Inception(1280, 160, 112, 224, 24, 64, 64)
        self.c4 = Inception(1728, 128, 128, 256, 24, 64, 64)
        self.d4 = Inception(2176, 112, 144, 288, 32, 64, 64)
        self.e4 = Inception(2640, 256, 160, 320, 32, 128, 128)

        self.max_pool4 = nn.MaxPool2d(3, stride=2, padding=1)

        self.a5 = Inception(3344, 256, 160, 320, 32, 128, 128)
        self.b5 = Inception(4048, 384, 192, 384, 48, 128, 128)

        self.avg_pool = nn.AvgPool2d(kernel_size=7, stride=1)

        self.dropout = nn.Dropout(0.4)

        self.classifier = nn.Linear(4944, num_classes)
